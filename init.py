...
from artists_manager import save_artist_popularity,read_file_to_list_of_dicts
...
tracks_id = get_tracks_id_from_albums(albums,sp,730)

print("\n--- PASO 3: Obteniendo info de tracks ---")
tracks_info = get_tracks_info(tracks_id,sp)

print("\n--- PASO 4: Calculando scores ---")
calculate_score(tracks_info,artists,0.6,0.0050,0.6,1.3)
